...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/blog/hello')) {
            ...
            // sdz_blog_controler
            if (0 === strpos($pathinfo, '/blog/hello2') && preg_match('#^/blog/hello2/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sdz_blog_controler')), array (  '_controller' => 'Sdz\\BlogBundle\\Controller\\BlogController::indexAction',));
            }
